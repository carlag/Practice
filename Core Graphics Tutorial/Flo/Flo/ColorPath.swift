...
//
//    init(startColor: UIColor, endColor: UIColor, path: UIBezierPath, segment: Segment) {
...
//    }
//    
//    mutating func draw(center: CGPoint, radius:  CGFloat, arcWidth: CGFloat) {
//        
...
//        }
//        
//        for sector in segment.start..<segment.end {
//            
//            let gradientPath = UIBezierPath(arcCenter: center,
//                                          radius: radius,
//                                          startAngle: CGFloat(sector)*π/180,
//                                          endAngle: (CGFloat(sector) + CGFloat(1))*π/180,
//                                          clockwise: true)
//            gradientPath.lineWidth = arcWidth
//            
//            let numerator = CGFloat(sector) - CGFloat(segment.start)
//            let denominator = CGFloat(segment.end) - CGFloat(segment.start)
//
//
//            let percent = numerator/denominator
//            self.color = self.getGradient(color1: startColor, color2: endColor, percent: percent)
//            
//            self.color?.setFill()
//            self.color?.setStroke()
//            
//            print("sector: \(sector) -> \(self.color!)")
//            gradientPath.fill()
//            gradientPath.stroke()
//            
//        }
